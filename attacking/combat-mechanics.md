...
- Sentinel (防禦力 +150%)：
  - 依據 [combat-formulas.md](battlestats/combat-formulas.md) 的公式：Mitigation = 0.5 + 0.435 × LOG10(Defense / Strength)
  - 假設基礎屬性比為 1:1 (減傷 50%)，防禦力變為 2.5 倍後，減傷率提升至 67.31%。
  - 折算因子 = (1 - 0.6731) / (1 - 0.50) = 0.6538
- Vanguard (敏捷度 +150%)：
  - 依據 [combat-formulas.md](battlestats/combat-formulas.md) 的公式：Hit Chance = 0.5 + 0.278 × LOG10(Speed / Dexterity)
