...
租用或購買 PI 時，必須確保其配備了 Landing Strip 與飛行員 (Pilot)：
- 旅遊加成：減少 30% 的飛行時間。
- 負重加成：額外增加 +10 項物品攜帶量。
- 代價規劃：雖然 3600 Happy 的 PI 租金約為每月 12m，但額外負重所帶來的花卉/娃娃利潤能完全抵銷這筆開銷。
...
- 大型行李箱 (Large Suitcase)：與 PI 配合使用，可再額外增加 +4 攜帶量，總載貨量將大幅提升。
