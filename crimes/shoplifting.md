...
Shoplifting 是一項涉及安保規律與聲名狼藉度 (Notoriety) 管理的犯罪，屬於盜竊 (Theft) 類別。本犯罪屬於 [[crimes/crimes-2.0-overview|Crimes 2.0]] 系統的一部分。
...
- 輔助道具 (不具扣除性)：
    - Mountain Bike (增強器)：提升 CS/CE 獲得，並解鎖高價值產出。取得途徑：[[crimes/search-for-cash|Junkyard 搜尋]]或 [[crimes/pickpocketing|扒竊]] Cyclist。
    - Torn City Times (報紙)：解鎖所有地點的額外結果。取得途徑：[[crimes/search-for-cash|SFC 地鐵 (Subway)]] 唯一發現。
...
- 核心：僅在安保系統（特別是守衛）處於維護/休息狀態時進入。這不但是為了安全，更是獲取 [[attacking/special-ammo|特殊彈藥 (Special Ammo)]] 的唯一機會。
