...
- 城市工作：Law 法律職業能顯著提升犯罪進度。
- 派系 Perk：最高可提供 10% 的犯罪進度加成。
- 教育課程：心理學學士學位 (Psychology bachelor) 在 2.0 中非常強大。
- 增強器 (Enhancers)：
...
- 被動累積 (Passive)：利用時間或冷卻機制，作為背景操作，不應讓其佔用過多主動 Nerve。
  - Card Skimming：安裝後放著累積資料。
  - Forgery：啟動生產後等待冷卻，非必要不頻繁檢查。
  - Scamming：依賴受教育解鎖的被動郵件收集器，累積達 20,000 封後才集中消耗。
  - Bootlegging：將 DVD 交給員工處理，定期檢查庫存即可。
