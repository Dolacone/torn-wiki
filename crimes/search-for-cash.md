...
SFC (Search For Cash) 是 [[crimes/crimes-2.0-overview|Crimes 2.0]] 的入門犯罪，也是解鎖後續許多犯罪零件的主要途徑。本犯罪屬於特殊 (Special) 類別。
...
- Glasses (Enhancer)：提升 5% 的 CE 與 CS 獲得。取得途徑：地鐵搜索 (Subway) 或 [[crimes/pickpocketing|扒竊商務女性 (Pickpocketing)]] Businesswoman。
...
- 重點產出：Card Skimmer ([[crimes/card-skimming|信用卡側錄器]])、Spray Can ([[crimes/graffiti|噴漆罐]])。
