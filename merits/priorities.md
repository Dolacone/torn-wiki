# 功勳分配指南 (Merits Assignment Guide)
...
- 住院時長 (Hospitalizing)
  - 點至 7 級可減少特定任務 (Mission) 所需的擊打次數。
- 大師級搶劫 (Masterful Looting)
  - 僅針對專精於搶劫 (Mugging) 的玩家有意義。

## 低優先級 (Low Priority - 限制使用場景)
