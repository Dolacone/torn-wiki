# 派系系統詳解與操作指南 (Faction Overview & How-to)
...
- Steadfast：提升四項戰鬥屬性的訓練效率 (最高 30%)，詳見 [[battlestats/training-strategy]]。
- Toleration：減少藥物負面影響 (最高 50%)。
- Excursion：增加旅行載貨量 (+10) 並縮短飛行時間，詳見 [[general/traveling]]。
...
- 詳細機制見 [[factions/organized-crime-2.0]]。
